 ...
 * @author nwright
 */
public class PositionRestrictionInputModelFactory
{
 ...
 public static String REFERENCE_ORGPOSITIONRESTRICTION = "Organizations.xls";
 
 public static Properties getDefaultConfig ()
 {
  Properties defaultProps = new Properties ();
  defaultProps.put (EXCEL_FILES_DEFAULT_DIRECTORY_KEY, RESOURCES_DIRECTORY);
  defaultProps.put (EXCEL_FILES_KEY + "1", REFERENCE_ORGPOSITIONRESTRICTION);
  return defaultProps;
 }
 ...
 public PositionRestrictionInputModel getModel ()
 {
...
//    System.out.println ("adding excelFile(" + i + ")=" + excelFileName);
  ...
  PosRestrictionInputModelExcelImpl model =
                                   new PosRestrictionInputModelExcelImpl (reader);
//  ContextFactory contextFactory = new ContextFactory ();
//  contextFactory.setConfig (config);
//  model.setContext (contextFactory.getInstance ());
  PositionRestrictionInputModelCache cache = new PositionRestrictionInputModelCache (model);
  return cache;
 }
}
