 ...
 * @author nwright
 */
public class StandardizedTestInputModelFactory
{

 public static final String RESOURCES_DIRECTORY = "resources";
 public static String STANDARDIZED_TESTS_XLS = "StandardizedTests.xls";
 ...
 public static final String EXCEL_FILES_KEY =
                            "standardized.test.loader.model.excel.file#";
 ...
 public static Properties getDefaultConfig ()
 {
  ...
  defaultProps.put (EXCEL_FILES_KEY + "1", STANDARDIZED_TESTS_XLS);
  return defaultProps;
 }
 ...
 public StandardizedTestInputModel getModel ()
 {
...
//    System.out.println ("adding excelFile(" + i + ")=" + excelFileName);
  ...
  StandardizedTestInputModelExcelImpl model =
                                   new StandardizedTestInputModelExcelImpl (reader);
//  ContextFactory contextFactory = new ContextFactory ();
//  contextFactory.setConfig (config);
//  model.setContext (contextFactory.getInstance ());
  StandardizedTestInputModelCache cache = new StandardizedTestInputModelCache (model);
  return cache;
 }
}
