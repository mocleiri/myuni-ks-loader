...
INSERT INTO KRIM_ROLE_T (ACTV_IND,KIM_TYP_ID,NMSPC_CD,OBJ_ID,ROLE_ID,ROLE_NM,VER_NBR) VALUES ('Y','1','MYUNI-KS-CM','MYUNI_WF_DEPT_CURRIC_MGR',KRIM_ROLE_ID_S.NEXTVAL,'Department Curriculum Manager',1)
/
INSERT INTO KRIM_ROLE_T (ACTV_IND,KIM_TYP_ID,NMSPC_CD,OBJ_ID,ROLE_ID,ROLE_NM,VER_NBR) VALUES ('Y','1','MYUNI-KS-CM','MYUNI_WF_DEPT_CHAIR',KRIM_ROLE_ID_S.NEXTVAL,'Department Chair',1)
/
INSERT INTO KRIM_ROLE_T (ACTV_IND,KIM_TYP_ID,NMSPC_CD,OBJ_ID,ROLE_ID,ROLE_NM,VER_NBR) VALUES ('Y','1','MYUNI-KS-CM','MYUNI_WF_COLL_CURRIC_MGR',KRIM_ROLE_ID_S.NEXTVAL,'College Curriculum Manager',1)
/
