...
-- (Not assignging this permission in UMD-CM)
-- INSERT INTO KRIM_ROLE_PERM_T (ACTV_IND,OBJ_ID,PERM_ID,ROLE_ID,ROLE_PERM_ID,VER_NBR)
...
-- Grant View Admin Tab Permission to KS IDM Admin Role (allows role to use Admin screens)
INSERT INTO KRIM_ROLE_PERM_T (ACTV_IND,OBJ_ID,PERM_ID,ROLE_ID,ROLE_PERM_ID,VER_NBR) VALUES ('Y',sys_guid(),(SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD='UMD-RICE' AND NM='View Admin Tab'),(SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD='KS-SYS' AND ROLE_NM='Kuali Student IDM Admin'),KRIM_ROLE_PERM_ID_S.NEXTVAL,1)
/

-- Grant KIM Record Lookup Permission to KS IDM Admin Role
INSERT INTO KRIM_ROLE_PERM_T (ACTV_IND,OBJ_ID,PERM_ID,ROLE_ID,ROLE_PERM_ID,VER_NBR) VALUES ('Y',sys_guid(),(SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD='UMD-RICE' AND NM='Look Up KIM Records'),(SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD='KS-SYS' AND ROLE_NM='Kuali Student IDM Admin'),KRIM_ROLE_PERM_ID_S.NEXTVAL,1)
/

-- Grant Inquire into KIM Records Permission to KS IDM Admin Role
INSERT INTO KRIM_ROLE_PERM_T (ACTV_IND,OBJ_ID,PERM_ID,ROLE_ID,ROLE_PERM_ID,VER_NBR) VALUES ('Y',sys_guid(),(SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD='UMD-RICE' AND NM='Inquire into KIM Records'),(SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD='KS-SYS' AND ROLE_NM='Kuali Student IDM Admin'),KRIM_ROLE_PERM_ID_S.NEXTVAL,1)
/

-- Grant Initiate KIM Document (to edit roles) Permission to KS IDM Admin Role
INSERT INTO KRIM_ROLE_PERM_T (ACTV_IND,OBJ_ID,PERM_ID,ROLE_ID,ROLE_PERM_ID,VER_NBR) VALUES ('Y',sys_guid(),(SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD='UMD-RICE' AND NM='Initiate Identity Management Document'),(SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD='KS-SYS' AND ROLE_NM='Kuali Student IDM Admin'),KRIM_ROLE_PERM_ID_S.NEXTVAL,1)
/
